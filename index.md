...
\[fbds_resolve()\], o resolvedor universal do pacote. Nome ambíguo
(existe em mais de uma UF) nunca é escolhido em silêncio: gera erro
...
com confirmação no primeiro uso em sessão interativa. Para outro
diretório:
