...
<qgis version="3.28" styleCategories="Symbology">
  <renderer-v2 attr="RIO" type="categorizedSymbol" symbollevels="0" forceraster="0" enableorderby="0">
    <categories>
    <category symbol="0" value="presente" label="presente" render="true"/>
    <category symbol="1" value="ausente" label="ausente" render="true"/>
    </categories>
    <symbols>
