...
<qgis version="3.28" styleCategories="Symbology">
  <renderer-v2 attr="HIDRO" type="categorizedSymbol" symbollevels="0" forceraster="0" enableorderby="0">
    <categories>
    <category symbol="0" value="curso d'água (0 - 10m)" label="curso d'água (0 - 10m)" render="true"/>
    <category symbol="1" value="curso d'água (10 - 50m)" label="curso d'água (10 - 50m)" render="true"/>
    <category symbol="2" value="curso d'água (&gt;10m)" label="curso d'água (&gt;10m)" render="true"/>
    <category symbol="3" value="massa d'água" label="massa d'água" render="true"/>
    <category symbol="4" value="nascente" label="nascente" render="true"/>
    </categories>
    <symbols>
